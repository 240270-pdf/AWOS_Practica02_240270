...
console.log(`El usuario con id: ${property1.ownerID} esta rentando un: ${property1.name} el cual se describe cómo: ${property1.description} 
    por un precio de: ${property1.price} con los servicios incluidos de: ${property1.includedServices}  ${property1.isSaleable?", actualmente esta a la venta": "que por el momento no esta a la venta"}.` );
...
//Creamos una función para darle formato a la fecha y sea más fácil de leer por el usuario
...
const buyerBid = (seller, buyer, property, price_bidded) => {
    ...
    console.log(
        `El usuario: ${buyerID} (${buyerEmail}) está realiozando una oferta al usuario: ${sellerID} (${sellerEmail})
